...
sed -i 's/set wireless.default_radio${devidx}.ssid=OpenWrt/set wireless.default_radio${devidx}.ssid=Openwrt-x86-generic/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
# meus pacotes (BETA)
